...
export const translations = {
  en: {
    ...
    common: {
      ...
      messages: {
        ...
        locationRequired: 'You must select a location',
  ...
  username_hint: 'Letters, numbers, dots and underscores only.',
      ...
      toasts: {
        ...
        avatarDbError: 'Error updating avatar in database',
        avatarUploadError: 'Unexpected error uploading avatar',
  ...
  this_quarter: 'This Quarter',
    ...
    jobs: {
      ...
      toasts: {
        ...
        vacancyClosed: 'Vacancy closed successfully',
        vacancyCloseError: 'Error closing vacancy',
        vacancyLoadError: 'Could not load vacancies',
        vacancyEditLoadError: 'Error loading vacancy',
        locationsLoadError: 'Error loading locations',
        titleRequired: 'Title is required',
        descriptionRequired: 'Description is required',
        applicationSent: 'Application sent successfully',
        applicationAccepted: 'Application accepted',
        applicationRejected: 'Application rejected',
        applicationLoadError: 'Error loading your applications',
        reviewSent: 'Review sent successfully',
        profileUpdated: 'Profile updated successfully',
        chatStartError: 'Cannot start chat at this time',
        chatError: 'Error starting chat',
        onlyPdfDocx: 'Only PDF or DOCX files are allowed',
  ...
  es: {
    ...
    jobs: {
      ...
      toasts: {
        ...
        vacancyClosed: 'Vacante cerrada exitosamente',
        vacancyCloseError: 'Error al cerrar la vacante',
        vacancyLoadError: 'No se pudieron cargar las vacantes',
        vacancyEditLoadError: 'Error al cargar la vacante',
        locationsLoadError: 'Error al cargar ubicaciones',
        titleRequired: 'El título es requerido',
        descriptionRequired: 'La descripción es requerida',
        applicationSent: 'Aplicación enviada exitosamente',
        applicationAccepted: 'Aplicación aceptada',
        applicationRejected: 'Aplicación rechazada',
        applicationLoadError: 'Error al cargar tus aplicaciones',
        reviewSent: 'Review enviada exitosamente',
        profileUpdated: 'Perfil actualizado exitosamente',
        chatStartError: 'No se puede iniciar el chat en este momento',
        chatError: 'Error al iniciar el chat',
        onlyPdfDocx: 'Solo se permiten archivos PDF o DOCX',
        fileTooLarge: 'El archivo debe ser menor a 5MB',
      },
    },
  ...
  username_hint: 'Solo letras, números, puntos y guiones bajos.',
      ...
      toasts: {
        ...
        avatarDbError: 'Error al actualizar el avatar en la base de datos',
        avatarUploadError: 'Error inesperado al subir el avatar',
