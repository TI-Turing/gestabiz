      ...
      <div className="bg-gradient-to-b from-background to-muted/30">
          ...
          <div className="container mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <Card className="relative bg-card border-purple-200 shadow-2xl">
                        ...
                        <div className="space-y-2">
                          {MOCK_APPOINTMENTS.map((appt) => (
                            <div key={appt.name} className="flex items-center gap-3 bg-muted/50 rounded-lg p-2.5">
                              ...
                              <Badge className="text-xs bg-green-50 text-green-800 border-green-200 shrink-0 gap-1">
        ...
        <section id="features" className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <Badge className="mb-4 bg-purple-100 text-purple-800 border-purple-300">{t('landing.features.badge')}</Badge>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {FEATURES.map((feature) => (
                <Card
                  ...
                  className="bg-card border-border hover:border-purple-300 hover:shadow-md transition-all duration-200 group"
                >
                  <CardContent className="p-6 space-y-4">
                    <div className={`w-11 h-11 rounded-lg ${feature.iconBg} flex items-center justify-center`}>
                      <feature.icon className={`h-5 w-5 ${feature.iconColor}`} />
                    </div>
                    <h3 className="text-lg font-semibold text-foreground group-hover:text-purple-700 transition-colors duration-200">
                      {t(feature.titleKey)}
                    </h3>
        ...
        <section id="benefits" className="py-20 px-4">
          <div className="container mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <Badge className="bg-purple-100 text-purple-800 border-purple-300">{t('landing.benefits.badge')}</Badge>
                  ...
                  <CardContent className="p-6 md:p-8 space-y-6">
                    ...
                    <div className="border-t border-border pt-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <Badge className="bg-purple-100 text-purple-800 border-purple-200">{t('landing.benefits.calculator.recovered')}</Badge>
                      </div>
        ...
        <section id="pricing" className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <Badge className="mb-4 bg-purple-100 text-purple-800 border-purple-300">{t('landing.pricing.badge')}</Badge>
              <h2 className="text-4xl font-bold mb-4 text-foreground">
        ...
        <section id="testimonials" className="py-20 px-4">
          <div className="container mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
              <div>
                <Badge className="mb-3 bg-purple-100 text-purple-800 border-purple-300">{t('landing.testimonials.badge')}</Badge>
                ...
                >
                  <CardContent className="p-6 space-y-4 flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-border">
                      ...
                      <Badge className="bg-emerald-50 text-emerald-800 border-emerald-200 text-xs shrink-0">
              ...
              <CardContent className="p-12 text-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  ...
                  <Button
                    size="lg"
                    variant="secondary"
                    className="bg-white/20 text-white hover:bg-white/30 text-lg border border-white/30 shadow-md transition-colors duration-200"
