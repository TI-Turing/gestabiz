        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link to="/para/salones" className="hover:text-purple-600">Para Salones de Belleza</Link>
              </li>
              <li>
                <Link to="/para/clinicas" className="hover:text-purple-600">Para Clínicas Médicas</Link>
              </li>
              <li>
                <Link to="/para/barberias" className="hover:text-purple-600">Para Barberías</Link>
              </li>
              <li>
                <Link to="/para/gimnasios" className="hover:text-purple-600">Para Gimnasios</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link to="/blog" className="hover:text-purple-600">{t('landing.footer.resources.blog')}</Link>
              </li>
              <li>
                <Link to="/blog/como-reducir-ausencias-citas-whatsapp" className="hover:text-purple-600">
                  Reducir ausencias con WhatsApp
                </Link>
              </li>
              <li>
                <Link to="/blog/software-salones-belleza-colombia-2026" className="hover:text-purple-600">
          ...
          <div>
            ...
            <div className="mt-6">
              <h5 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Más Verticales</h5>
              <ul className="space-y-1 text-xs text-gray-500">
                <li><Link to="/para/spas" className="hover:text-purple-600">Spas y Estética</Link></li>
                <li><Link to="/para/odontologos" className="hover:text-purple-600">Odontología</Link></li>
                <li><Link to="/para/psicologos" className="hover:text-purple-600">Psicología</Link></li>
                <li><Link to="/para/fisioterapeutas" className="hover:text-purple-600">Fisioterapia</Link></li>
                <li><Link to="/para/entrenadores" className="hover:text-purple-600">Entrenadores</Link></li>
                <li><Link to="/para/coworkings" className="hover:text-purple-600">Coworking</Link></li>
              </ul>
            </div>
          </div>
        </div>
