...
export function AdminRolePreferences({ business }: AdminRolePreferencesProps) {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'info' | 'branding' | 'notifications' | 'tracking' | 'calendario' | 'chat' | 'payments'>('info')
  ...
  return (
    <>
      ...
      {activeSubTab === 'payments' && <PaymentSettingsTab businessId={business.id} />}
