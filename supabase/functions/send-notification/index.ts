...
// Template HTML para nueva cita asignada al profesional/empleado
function createAppointmentNewEmployeeEmail(vars: Record<string, string>, subject: string): string {
  ...
  const locationRow = location ? `
                      <tr>
                        <td style="padding:10px 0;color:#64748b;font-size:15px;border-bottom:1px solid #e2e8f0;vertical-align:middle;">📍 Sede</td>
                        <td style="padding:10px 0;color:#1e293b;font-weight:600;font-size:15px;text-align:right;border-bottom:1px solid #e2e8f0;vertical-align:middle;">${location}</td>
                      </tr>` : ''
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.3);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#a855f7 0%,#9333ea 100%);padding:40px 30px;text-align:center;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center">
                    <div style="display:inline-block;width:80px;height:80px;background:white;border-radius:20px;font-size:40px;line-height:80px;text-align:center;box-shadow:0 4px 20px rgba(0,0,0,0.1);">🗓️</div>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding-top:16px;">
          ...
          <tr>
            <td style="padding:40px 30px;">
              <h1 style="margin:0 0 12px;color:#1e293b;font-size:24px;font-weight:700;text-align:center;">📋 Nueva Cita Asignada</h1>
              <p style="margin:0 0 32px;color:#64748b;font-size:16px;text-align:center;">Hola <strong style="color:#1e293b;">${employeeName}</strong>, tienes una nueva cita agendada.</p>
              <!-- Detalles -->
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border-radius:12px;">
                <tr>
                  <td style="padding:20px 24px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="padding:10px 0;color:#64748b;font-size:15px;border-bottom:1px solid #e2e8f0;vertical-align:middle;">👤 Cliente</td>
                        <td style="padding:10px 0;color:#1e293b;font-weight:600;font-size:15px;text-align:right;border-bottom:1px solid #e2e8f0;vertical-align:middle;">${clientName}</td>
                      </tr>
                      <tr>
                        <td style="padding:10px 0;color:#64748b;font-size:15px;border-bottom:1px solid #e2e8f0;vertical-align:middle;">📅 Fecha</td>
                        <td style="padding:10px 0;color:#1e293b;font-weight:600;font-size:15px;text-align:right;border-bottom:1px solid #e2e8f0;vertical-align:middle;">${date}</td>
                      ...
                      <tr>
                        <td style="padding:10px 0;color:#64748b;font-size:15px;${location ? 'border-bottom:1px solid #e2e8f0;' : ''}vertical-align:middle;">✂️ Servicio</td>
                        <td style="padding:10px 0;color:#1e293b;font-weight:600;font-size:15px;text-align:right;${location ? 'border-bottom:1px solid #e2e8f0;' : ''}vertical-align:middle;">${service}</td>
                      </tr>
                      ${locationRow}
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:16px 24px 20px;text-align:center;">
                    <p style="margin:0;color:#64748b;font-size:15px;">Revisa tu agenda en la app para más detalles.</p>
                  </td>
                </tr>
              </table>
            </td>
