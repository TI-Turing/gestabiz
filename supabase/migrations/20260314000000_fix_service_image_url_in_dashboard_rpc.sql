-- =====================================================
-- FIX: Agregar image_url y duration_minutes al objeto service
--      en la función get_client_dashboard_data
-- =====================================================
-- Fecha: 14 de marzo de 2026
-- Problema: El campo service.image_url y service.duration_minutes
--           no se incluían en el JSONB de appointments, por lo que
--           las tarjetas de citas no podían mostrar imagen de fondo.
-- Solución: Reemplazar la función con los campos corregidos.
-- =====================================================
