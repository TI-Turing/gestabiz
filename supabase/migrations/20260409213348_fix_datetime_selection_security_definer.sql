-- Fix: La RPC get_datetime_selection_data debe ser SECURITY DEFINER para que
-- un cliente pueda ver TODAS las citas del empleado/recurso al verificar disponibilidad.
-- Con SECURITY INVOKER (default), RLS filtraba las citas de otros clientes
-- haciendo que slots ocupados aparecieran como disponibles.
