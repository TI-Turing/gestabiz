-- =====================================================
-- FIX: Business Suggestions por Ciudad Preferida
-- =====================================================
-- Fecha: 3 de febrero de 2026
-- Problema: La función get_client_dashboard_data retorna '[]' en suggestions
--           en lugar de filtrar negocios por la ciudad preferida del usuario
-- Solución: Actualizar la función para incluir lógica de sugerencias
-- =====================================================
...
BEGIN
  ...
  -- =====================================================
  -- CORREGIDO: Filtra por ciudad/región preferida si se proporciona
  -- Si NO se proporciona, muestra los top 6 negocios por rating
  SELECT COALESCE(jsonb_agg(
    jsonb_build_object(
      'id', b.id,
      'name', b.name,
...
Incluye: appointments, reviewedAppointmentIds, pendingReviewsCount, favorites, 
suggestions (FILTRADAS por ciudad/región preferida), y stats.
